TT(todo today): 
cash_all：现金，交易性金融资产，其他流动资产（当前看到的主要是理财产品）
invest：可供出售金融资产，长期股权投资（equity investee）当前是分开的。
预计负债：例如司法判决的债务。当前算作WC-，不应该算作WC-，因为这会造成WC_net偏低，仿佛是运营很高效，其实是吃官司导致的，从而导致分析南辕北辙。算作Liability也不合适，它在逻辑上和投入资本无关。应该算作Cash-，从Cash中减去。
一般工商业企业中有金融业务的，把金融业务的条目剔除。
